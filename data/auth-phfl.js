/* ===== PHFL League Auth Config (Supabase-backed) =====
 *
 ...
 *        WHERE u.email = 'their@email.com' AND l.slug = 'phfl-2026';
 *   3. Next time they visit commissioner.html they'll be granted access.
 * ===================================================================== */

window.COMM_AUTH = {
  leagueKey:  'phfl_comm_v2',
  leagueSlug: 'phfl-2026',
  leagueName: 'Playa Hatas Fantasy League'
};
